...
const register = async (req, res) => {
    ...
    let threeDays = 3000 * 60 * 60 * 25;
    res.cookie('accessToken', token, { sameSite: "none", httpOnly: true, secure: false, maxAge: threeDays })
...
const login = async (req, res) => {
    ...
    res.cookie("authUser", user.name, { maxAge: oneDay })
...
const logout = (req, res) => {
    ...
    res.cookie("jwt", "nothing", { maxAge: oneSecond, sameSite: "none", httpOnly: true, secure: false })
